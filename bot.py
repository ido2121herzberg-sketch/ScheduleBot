...
- אם עידו מזכיר פעילות עם יום מפורש שהוא רוצה לעשות ("שיעור ריקוד בשישי", "הגעה למשרדים בשלישי") → זה אירוע ב-events באותו יום. זה אף פעם לא move ולא skip, ולעולם אל תשמיט אותו. (אם יש שלילה — "בלי"/"אין"/"לא" — זה skip, לא אירוע.)
